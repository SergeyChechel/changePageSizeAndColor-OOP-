...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Cusomizator; });
...
/*#__PURE__*/
function () {
  function Cusomizator() {
    var _this = this;

    _classCallCheck(this, Cusomizator);
  ...
  _createClass(Cusomizator, [{
    ...
    value: function onScaleChange(e) {
      ...
      var recurcy = function recurcy(element) {
        element.childNodes.forEach(function (node) {
          if (node.nodeName === '#text' && node.nodeValue.replace(/\s+/ig, '').length > 0) {
